...
public class ClickGuiScreen extends Screen {
    ...
    protected void init() {
        ...
        Map<ModuleCategory, List<ExternalModRegistry.ExternalMod>> externalMods =
                ExternalModRegistry.getAvailableModsByCategory();
        ...
        for (ModuleCategory category : ModuleCategory.values()) {
            ...
            List<ExternalModRegistry.ExternalMod> extMods = externalMods.get(category);
            ...
            for (ExternalModRegistry.ExternalMod mod : extMods) {
                addRenderableWidget(new ExternalModButton(rowX, y, rowWidth, GuiTheme.ROW_HEIGHT, mod, this));
                y += GuiTheme.ROW_HEIGHT + 2;
            }

            int totalRows = modules.size() + extMods.size();
            int thisPanelHeight = GuiTheme.PANEL_HEADER_HEIGHT
                    + totalRows * (GuiTheme.ROW_HEIGHT + 2)
